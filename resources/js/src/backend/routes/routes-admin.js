...
let routes = [
  ...
  },
  {
    ...
    name: "Units",
    component: () =>
      import("../../../components/backend/admin/units/Index.vue"),
    meta: {
      auth: true,
    },
  },
  {
    path: "/course-units/create",
    name: "CreateUnit",
    component: () =>
      import("../../../components/backend/admin/units/Create.vue"),
    meta: {
      auth: true,
    },
  },
  ...
  {
    path: "/course-units/:id/topics",
    name: "CourseUnitTopics",
    component: () =>
      import("../../../components/backend/admin/units/Topics.vue"),
  },
  {
    path: "/:pathMatch(.*)*",
    redirect: "/",
